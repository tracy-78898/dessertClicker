...
import com.example.dessertclicker.viewmodel.DessertClickerViewModel
...
private fun DessertClickerApp(desserts: List<Dessert>) {
    ...
    Scaffold(
            ...
            DessertClickerAppBar(
                onShareButtonClicked = {
                    shareSoldDessertsInformation(
                        ...
                        dessertsSold = state.dessertsSold, // Use state value
                        revenue = state.revenue  // Use state value
                    )
                },
                modifier = Modifier
                    .fillMaxWidth()
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = { index ->
                // Update the ViewModel state based on the clicked dessert
                viewModel.updateDessertState(desserts, index)
            },
